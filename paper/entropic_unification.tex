% =====================================================================
% RESULTS WITHDRAWN (v1.3, July 2026). The quantitative results in this
% manuscript came from the v1.2 pipeline, whose defects made the headline
% findings circular (hand-placed Gaussian entropy profile; curvature not
% matching the stated ansatz; Euclidean contractions). DO NOT SUBMIT.
% See README.md "Results Status (v1.3)". Re-run on v1.3 before any use.
% =====================================================================
